    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 m-b-30 header-title">Virtual Machine Status</h4>
                            ...
                            <table class="table table-vertical mb-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>2145</td>
                                        <td>
                                            <img src="/admin-asset/assets/images/products/2.jpg" alt="user-image" style="height: 46px;" class="mr-2" />
                                            Shovon Rahman Shuvo
                                        </td>
                                        <td>
                                            <span class="badge badge-pill badge-success"><i class="fa fa-play"></i> Play</span>
                                            <span class="badge badge-pill badge-warning"><i class="fa fa-pause"></i> Pause</span>
                                            <span class="badge badge-pill badge-danger"><i class="fa fa-resume"></i> Stop</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-pill badge-danger"><i class="fa fa-trash"></i> Delete</span>
                                        </td>
                                        <td>
                                            C://desktop/user/folder-1/file
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>M03075</td>
                                        <td>
                                            <img src="/admin-asset/assets/images/products/3.jpg" alt="user-image" style="height: 46px;" class="mr-2" />
                                            Dil Ashrafi Anandi
                                        </td>
                                        <td>
                                            <span class="badge badge-pill badge-success"><i class="fa fa-play"></i> Play</span>
                                            <span class="badge badge-pill badge-warning"><i class="fa fa-pause"></i> Pause</span>
                                            <span class="badge badge-pill badge-danger"><i class="fa fa-stop"></i> Stop</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-pill badge-danger"><i class="fa fa-trash"></i> Delete</span>
                                        </td>
